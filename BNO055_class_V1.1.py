...
#Functions for reading BNO055 orientation sensor data and streaming via ESP32 to Hanglog app on Android phone.

#V1-0 (13/12/2020): STABLE VERSION, functioning fine
#V1-1 (11/01/2020): Modified to include direct gyro outputs into datastream, now dropping other data DO NOT USE THIS VERSION until fixed.
